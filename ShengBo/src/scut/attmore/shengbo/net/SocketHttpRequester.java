 ...
 * 
 */
package scut.attmore.shengbo.net;
...
public class SocketHttpRequester {
	/**
	 * 直接通过HTTP协议提交数据到服务器,实现如下面表单提交功能: <FORM METHOD=POST ACTION="[url=http://192.168.0.200:8080/ssi/fileload/test.do]http://192.168.0.200:8080/ssi/fileload/test.do[/url]"
	 ...
	 * 
	 * @param path
	 *            上传路径(注：避免使用localhost或127.0.0.1这样的路径测试，因为它会指向手机模拟器，你可以使用[url=http
	 *            ://www.itcast.cn/]http://www.itcast.cn[/url]或[url=http://
	 *            192.168.1.10:8080/]http://192.168.1.10:8080[/url]这样的路径测试)
	 * @param params
